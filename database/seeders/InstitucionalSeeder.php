...
class InstitucionalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        // Unidades
        $unidades = [
            ['nombre' => 'Pleno del Concejo Municipal', 'sigla' => 'PCM', 'descripcion' => 'Órgano deliberativo fiscalizador y legislativo', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Presidencia del Concejo', 'sigla' => 'PSC', 'descripcion' => 'Presidencia del Concejo Municipal de Potosí', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Vicepresidencia del Concejo', 'sigla' => 'VPS', 'descripcion' => 'Vicepresidencia del Concejo Municipal de Potosí', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Secretaría del Concejo', 'sigla' => 'SCM', 'descripcion' => 'Secretaría del Concejo Municipal de Potosi', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Comisión Jurídica y Desarrollo Institucional', 'sigla' => 'CJDI', 'descripcion' => 'Comisión Jurídica y Desarrollo Institucional', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Comisión Económica y Financiera', 'sigla' => 'CEF', 'descripcion' => 'Comisión Económica y Financiera', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Comisión de Desarrollo Territorial y Límites', 'sigla' => 'CDTL', 'descripcion' => 'Comisión de Desarrollo Territorial y Límites', 'estado' => true, 'fecha_creacion' => now()],
            ...
            ['nombre' => 'Comisión de Desarrollo Económico, Productivo y Agropecuario', 'sigla' => 'CDEPA', 'descripcion' => 'Comisión de Desarrollo Económico, Productivo y Agropecuario', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Comisión de Turismo, Cultura y Preservación de Áreas Históricas', 'sigla' => 'CTCPAH', 'descripcion' => 'Comisión de Turismo, Cultura y Preservación de Áreas Históricas', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Comisión de Medio Ambiente, Minería y Forestación', 'sigla' => 'CMAMF', 'descripcion' => 'Comisión de Medio Ambiente, Minería y Forestación', 'estado' => true, 'fecha_creacion' => now()],
            ...
            ['nombre' => 'Relaciones publicas', 'sigla' => 'RP', 'descripcion' => 'Relaciones publicas', 'estado' => true, 'fecha_creacion' => now()],
            ...
            ['nombre' => 'Unidad de Recursos Humanos', 'sigla' => 'URH', 'descripcion' => 'Unidad de Recursos Humanos', 'estado' => true, 'fecha_creacion' => now()],
            ...
            ['nombre' => 'Secretaría General', 'sigla' => 'SG', 'descripcion' => 'Secretaría General del Concejo Municipal de Potosí', 'estado' => true, 'fecha_creacion' => now()],
            ['nombre' => 'Otros Servicios Generales', 'sigla' => 'OSG', 'descripcion' => 'Otros Servicios Generales Relacionados al Concejo Municipal', 'estado' => true, 'fecha_creacion' => now()],
        ];
        ...
        $cargos=[
            ...
            ['nombre' => 'Asistente de Presidencia', 'descripcion' => 'Asistente del Presidente del Concejo Municipal', 'estado' => true],
            ['nombre' => 'Vicepresidente del Concejo', 'descripcion' => 'Vicepresidente del Concejo Municipal del Potosí', 'estado' => true],
            ['nombre' => 'Asistente de Vicepresidencia', 'descripcion' => 'Asistente del Vicepresidente del Concejo Municipal', 'estado' => true],
            ['nombre' => 'Concejal Secretaria', 'descripcion' => 'Secretaría del Concejo Municipal de Potosí', 'estado' => true],
            ['nombre' => 'Asistente de Concejal Secretaria', 'descripcion' => 'Asistente de Secretaría del Concejo Municipal', 'estado' => true],
            ['nombre' => 'Concejal', 'descripcion' => 'Representante de la ciudadanía a través de tres funciones fundamentales', 'estado' => true],
            ['nombre' => 'Asesor(a)', 'descripcion' => 'Asesor de la Comisión Correspondiente', 'estado' => true],
            ['nombre' => 'Jefe de Gabinete', 'descripcion' => 'Asistente de Secretaría del Concejo Municipal', 'estado' => true],
            ['nombre' => 'Asesor(a) Legal', 'descripcion' => 'Asesor(a) Legal del Concejo Municipal de Potosí', 'estado' => true],
            ['nombre' => 'Asistente', 'descripcion' => 'Asistente', 'estado' => true],
            ['nombre' => 'Asesor(a) Financiero', 'descripcion' => 'Asesor(a) Financiero', 'estado' => true],
            ['nombre' => 'Auxiliar', 'descripcion' => 'Auxiliar', 'estado' => true],
            ...
            ['nombre' => 'Auxiliar Secretario de Cámara', 'descripcion' => 'Auxiliar Secretario de Cámara', 'estado' => true],
            ...
            ['nombre' => 'Auxiliar de Protocolo', 'descripcion' => 'Auxiliar de Protocolo', 'estado' => true],
            ['nombre' => 'Contador', 'descripcion' => 'Contador', 'estado' => true],
            ['nombre' => 'Auxiliar de Contabilidad', 'descripcion' => 'Auxiliar de Contabilidad', 'estado' => true],
            ['nombre' => 'Responsable de Recursos Humanos', 'descripcion' => 'Responsable de Recursos Humanos', 'estado' => true],
            ['nombre' => 'Auxiliar de Recursos Humanos', 'descripcion' => 'Auxiliar de Recursos Humanos', 'estado' => true],
            ['nombre' => 'Jefe Administrativo y Finaciero', 'descripcion' => 'Jefe Administrativo y Finaciero', 'estado' => true],
            ['nombre' => 'Auxiliar de Jefatura Administrativa', 'descripcion' => 'Auxiliar de Jefatura Administrativa', 'estado' => true],
            ['nombre' => 'Responsable de Activos Fijos y Almacenes', 'descripcion' => 'Responsable de Activos Fijos y Almacenes', 'estado' => true],
            ['nombre' => 'Auxiliar de Activos Fijos', 'descripcion' => 'Auxiliar de Activos Fijos', 'estado' => true],
            ['nombre' => 'Encargado de Archivos', 'descripcion' => 'Encargado de Archivos', 'estado' => true],
            ['nombre' => 'Auxiliar de Digitalizacion', 'descripcion' => 'Auxiliar de Digitalizacion', 'estado' => true],
            ['nombre' => 'Auxiliar Catalogador', 'descripcion' => 'Auxiliar Catalogador', 'estado' => true],
            ['nombre' => 'Auxiliar de Archivos', 'descripcion' => 'Auxiliar de Archivos', 'estado' => true],
            ['nombre' => 'Responsable de Presupuestos y Tesorería', 'descripcion' => 'Responsable de Presupuestos y Tesorería', 'estado' => true],
            ['nombre' => 'Auxiliar de Presupuestos y Tesorería', 'descripcion' => 'Auxiliar de Presupuestos y Tesorería', 'estado' => true],
            ...
            ['nombre' => 'Auxiliar de Bienes, Servicios y Contrataciones', 'descripcion' => 'Auxiliar de Bienes, Servicios y Contrataciones', 'estado' => true],
            ['nombre' => 'Responsable de Sistemas', 'descripcion' => 'Responsable de Sistemas', 'estado' => true],
            ['nombre' => 'Auxiliar de Sistemas', 'descripcion' => 'Auxiliar de Sistemas', 'estado' => true],
        ...
        $funcionarios=[
            ...
            ['nombres' => 'Claudio German', 'apellidos' => 'Clemente Vedia', 'ci' => '1234568', 'celular' => '', 'correo' => 'claudio.clemente@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 14, 'id_cargo' => 3, 'gestion' => date('Y-m-d')],
            ['nombres' => 'María Del Carmen', 'apellidos' => 'Michel Araujo', 'ci' => '1234569', 'celular' => '', 'correo' => 'maría.michel@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 7, 'id_cargo' => 5, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Guido Armando', 'apellidos' => 'Cruz Mora', 'ci' => '12345610', 'celular' => '', 'correo' => 'guido.cruz@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 5, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Manuel Alejandro', 'apellidos' => 'Calizaya Limachi', 'ci' => '12345611', 'celular' => '', 'correo' => 'manuel.calizaya@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 8, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Eddy', 'apellidos' => 'Fernández Fuertes', 'ci' => '12345612', 'celular' => '', 'correo' => 'eddy.fernández@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 9, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Christie Mónica', 'apellidos' => 'Chacón Duran', 'ci' => '12345613', 'celular' => '', 'correo' => 'christie.chacón@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 10, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Ariel', 'apellidos' => 'Jiménez Gómez', 'ci' => '12345614', 'celular' => '', 'correo' => 'ariel.jiménez@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 11, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Jacqueline Lourdes', 'apellidos' => 'Gutiérrez Carrasco', 'ci' => '12345615', 'celular' => '', 'correo' => 'jacqueline.gutiérrez@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 12, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
            ['nombres' => 'Clementina', 'apellidos' => 'Aroni Mamani', 'ci' => '12345616', 'celular' => '', 'correo' => 'clementina.aroni@cmp.gob.bo', 'estado' => true, 'fecha_registro' => now(), 'id_unidad' => 13, 'id_cargo' => 7, 'gestion' => date('Y-m-d')],
